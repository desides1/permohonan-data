...
return [
    ...
    'backup' => [
        ...
        /*
         * The source files/directories and databases to backup.
         */
         ...
         */
        'encryption' => env('BACKUP_ARCHIVE_ENCRYPTION') ? 'default' : null,
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@bpkh.go.id'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'noreply@bpkh.go.id'),
                'name' => env('MAIL_FROM_NAME', 'BPKH Backup System'),
            ],
        ],
    ...
    'monitor_backups' => [
        [
            'name' => '',
            /*
              * The disk names on which the backups are stored.
              */
            'disks' => ['google_backup'],
            'health_checks' => [
